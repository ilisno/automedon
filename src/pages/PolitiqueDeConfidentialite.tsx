' dans le texte pour éviter les erreurs de parsing JSX.">
    ...
    <div className="min-h-screen flex flex-col bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-4 text-center">
        ...
        <div className="text-left max-w-3xl mx-auto space-y-4 text-gray-700 dark:text-gray-300">
          ...
          <ul className="list-disc list-inside ml-4 space-y-1">
            <li><strong>Firefox :</strong> <a href="https://support.mozilla.org/fr/kb/cookies-informations-sites-enregistrent" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">https://support.mozilla.org/fr/kb/cookies-informations-sites-enregistrent</a><br />
            ...
            <li><strong>Internet Explorer :</strong> <a href="https://support.microsoft.com/en-us/products/windows?os=windows-7" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">https://support.microsoft.com/en-us/products/windows?os=windows-7</a><br />
            ...
            <li><strong>Google Chrome :</strong> <a href="https://support.google.com/chrome/answer/95647?hl=fr" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">https://support.google.com/chrome/answer/95647?hl=fr</a><br />
