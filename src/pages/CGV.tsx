    ...
    <div className="min-h-screen flex flex-col bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-4 text-center">
        ...
        <div className="text-left max-w-3xl mx-auto space-y-4 text-gray-700 dark:text-gray-300">
          ...
          <p>
            Les convoyages de véhicules peuvent être effectués entre l’Île-de-France et toute région 
          ...
          <h3 className="text-xl font-semibold mt-4 mb-2">1.2. Demande de prestation</h3>
          <p>
            Le Donneur d'ordre fournit à AUTOMEDON, préalablement à la présentation du véhicule au fin 
          ...
          <h3 className="text-xl font-semibold mt-4 mb-2">1.3. Modifications des conditions initiales</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-4 mb-2">1.4. Commande et réservation du Convoyeur AUTOMEDON.</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-4 mb-2">1.5. Mode de paiement.</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-4 mb-2">1.6. Conditions de règlement.</h3>
          <p>
            Le paiement complet de la prestation est exigé une semaine avant la date de prise en 
            charge (Sauf urgence). 
          </p>
          <p>
            À défaut de paiement complet reçu au plus tard 7 jours avant la date de prise en charge 
          ...
          <h3 className="text-xl font-semibold mt-4 mb-2">1.7. Annulation de la part du Donneur d’ordre.</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold mt-4 mb-2">1.8. Annulation pour cas de force majeure.</h3>
          <p>
          ...
          <p>
            ...
            détention est interdite ou règlementée. À la remise du véhicule, le Donneur d’ordre – ou 
          ...
          <p>
            ...
            à des tiers les coordonnées des Donneurs d’ordre à des fins de sollicitation ou de 
          ...
          <p>
            URUK SAS 
            79 RUE D'ORADOUR 51000 CHÂLONS-EN-CHAMPAGNE  
          </p>
          <p>
          ...
          <p>
            À défaut d’accord amiable que les parties s’engagent à rechercher préalablement, toute 
            difficulté survenant dans l’interprétation ou l’exécution des présentes conditions 
            générales sera soumise aux tribunaux de Châlons-en-Champagne qui seront seuls 
            compétents, les parties faisant élection de domicile à Châlons-en-Champagne. 
          </p>
          ...
          <p>
            <strong>URUK SAS</strong><br />
            SAS, société par actions simplifiée au capital de 500 €<br />
            <strong>SIRET :</strong> 97759264100012<br />
            <strong>IBAN :</strong> FR76 3000 4001 4400 0101 9322 103<br />
            <strong>Banque :</strong> BNPPARB CHÂLONS EN CHAMP<br />
            <strong>Siège social :</strong> 79 RUE D'ORADOUR 51000 CHÂLONS-EN-CHAMPAGNE<br />
            <strong>Téléphone :</strong> +33 6 50 78 84 87<br />
            <strong>Assurance Flotte :</strong> HISCOX ASSURANCES<br />
            <strong>Assurance RC Prestataire de Services :</strong> HISCOX ASSURANCES<br />
            <strong>Site WEB :</strong> <a href="https://www.automedon.net" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">www.automedon.net</a>
          </p>
        </div>
        <Link to="/">
